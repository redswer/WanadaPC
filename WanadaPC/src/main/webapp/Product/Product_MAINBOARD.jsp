...
/* 비교 테이블 스타일 */
.compare_mainboard_one, .compare_mainboard_two {
...
/* 테이블 스타일 */
.compare_mainboard_one th, .compare_mainboard_two th {
    background-color: #f1f1f1;
    font-weight: bold;
    text-align: center;
...
.compare_mainboard_one td, .compare_mainboard_two td {
    padding: 12px;
    text-align: left;
...
/* 인텔 mainboard종류까지만 보이고 나머지 항목 스크롤 */
.compare_mainboard_two {
    max-height: 300px; /* 스크롤이 필요한 높이 설정 */
    overflow-y: auto;
}

.compare_mainboard_two table {
    width: 100%;
}

.compare_mainboard_two tr:nth-child(1) ~ tr {
     width: 100%;
}

/* 스크롤바 스타일 (웹킷 기반 브라우저) */
.compare_mainboard_two::-webkit-scrollbar {
    width: 8px;
}

.compare_mainboard_two::-webkit-scrollbar-thumb {
    background-color: #888;
    border-radius: 4px;
}

.compare_mainboard_two::-webkit-scrollbar-track {
    background-color: #f1f1f1;
}
...
<body class="mainboard_body">
    ...
    <div class="compare">
        <section>
            <div class="compare_mainboard_one" id="defaultOption">
                <table>
                    <colgroup>
            ...
            <div class="compare_mainboard_two">
                <table>
                    <tr>
                        <th>제조사</th>
                        <td></td>
