...
/* compare_gpu_one과 compare_gpu_two를 같은 박스에 넣기 */
.compare_gpu_container {
...
/* 비교 테이블 스타일 */
.compare_gpu_one, .compare_gpu_two {
...
/* 테이블 스타일 */
.compare_gpu_one th, .compare_gpu_two th {
    background-color: #f1f1f1;
    font-weight: bold;
    text-align: center;
...
.compare_gpu_one td, .compare_gpu_two td {
    padding: 12px;
    text-align: left;
...
/* 인텔 gpu종류까지만 보이고 나머지 항목 스크롤 */
.compare_gpu_two {
    max-height: 300px; /* 스크롤이 필요한 높이 설정 */
    overflow-y: auto;
}

.compare_gpu_two table {
    width: 100%;
}

.compare_gpu_two tr:nth-child(1) ~ tr {
     width: 100%;
}

/* 스크롤바 스타일 (웹킷 기반 브라우저) */
.compare_gpu_two::-webkit-scrollbar {
    width: 8px;
}

.compare_gpu_two::-webkit-scrollbar-thumb {
    background-color: #888;
    border-radius: 4px;
}

.compare_gpu_two::-webkit-scrollbar-track {
    background-color: #f1f1f1;
}
...
<body class="GPU_body">
    ...
    <div class="compare">
        <section>
            <div class="compare_gpu_one" id="defaultOption">
                <table>
                    <colgroup>
