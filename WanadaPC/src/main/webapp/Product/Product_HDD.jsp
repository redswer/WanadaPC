...
/* 비교 테이블 스타일 */
.compare_hdd_one, .compare_hdd_two {
...
/* 테이블 스타일 */
.compare_hdd_one th, .compare_hdd_two th {
	background-color: #f1f1f1;
	font-weight: bold;
	text-align: center;
...
.compare_hdd_one td, .compare_hdd_two td {
	padding: 12px;
	text-align: left;
...
.compare_hdd_two table {
	width: 100%;
}

.compare_hdd_two tr:nth-child(1) ~ tr {
	width: 100%;
}

/* 스크롤바 스타일 (웹킷 기반 브라우저) */
.compare_hdd_two::-webkit-scrollbar {
	width: 8px;
}

.compare_hdd_two::-webkit-scrollbar-thumb {
	background-color: #888;
	border-radius: 4px;
}

.compare_hdd_two::-webkit-scrollbar-track {
	background-color: #f1f1f1;
}
...
<body class="HDD_body">
	...
	<div class="compare">
		<section>
			<div class="compare_hdd_one" id="defaultOption">
				<table>
					<colgroup>
