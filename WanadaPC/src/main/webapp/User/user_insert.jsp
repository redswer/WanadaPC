...
<body>
	<div class="inner">
		<h1 class="logo_wanada">
			<a href="http://wanada.com" class="link"> <span class="blind">와나다</span>
			</a>
		</h1>
		<div class="signup-container">
			...
			<div class="form section">
				<div class="join_toggle" id="divToggle">
					<input type="checkbox" id="join_toggle" checked> <label
						for="join_toggle">실명 인증된 아이디로 가입</label>
				</div>
			</div>
			<form action="/user_insert" method="POST" name="userForm">
				...
				<div class="User_repassword">
					<label for="repassword">비밀번호 확인</label> <input type="password"
						id="repassword" name="repassword" placeholder="비밀번호를 다시 입력하세요">
				</div>
				<div class="User_gender">
					<label for="gender">성별</label> <input type="radio" id="gender1"
						name="gender" value="M"> <label for="gender1">남자</label> <input
						type="radio" id="gender2" name="gender" value="F"> <label
						for="gender2">여자</label>
				</div>
				<div class="User_phone">
					<label for="tel">휴대폰 번호</label> <input type="text" id="tel"
