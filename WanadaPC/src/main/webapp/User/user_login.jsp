            ...
            <div class="form login">
                <form action="/user_login" method="POST" name="userlogin">
                    <div class="form-group">
                        ...
                        <input type="text" id="email" name="email" size="13" maxlength="15" placeholder="아이디(e-mail)을 입력하세요">
                        @
                        <input type="text" id="customEmailDomain" name="customEmailDomain" size="13" maxlength="15" placeholder="직접 입력한 도메인">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" id="password" name="password" placeholder="비밀번호를 입력하세요" autocomplete="off">
                    </div>
